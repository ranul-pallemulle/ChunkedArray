// TenTusscher06 Endocardium test
...
void init_test(int n)
{
    ...
    gates.push_back(11);
    gates.push_back(12);
    concentrations.push_back(13);
    concentrations.push_back(14);
    concentrations.push_back(15);
	      ...
	      const NekDouble)
{
	...
	gates_tau[0][i] = var_rapid_time_dependent_potassium_current_Xr1_gate__tau_xr1;
	outarray[2][i] = var_rapid_time_dependent_potassium_current_Xr2_gate__xr2_inf;
	gates_tau[1][i] = var_rapid_time_dependent_potassium_current_Xr2_gate__tau_xr2;
	outarray[3][i] = var_slow_time_dependent_potassium_current_Xs_gate__xs_inf;
	gates_tau[2][i] = var_slow_time_dependent_potassium_current_Xs_gate__tau_xs;
	outarray[4][i] = var_fast_sodium_current_m_gate__m_inf;
	gates_tau[3][i] = var_fast_sodium_current_m_gate__tau_m;
	outarray[5][i] = var_fast_sodium_current_h_gate__h_inf;
	gates_tau[4][i] = var_fast_sodium_current_h_gate__tau_h;
	outarray[6][i] = var_fast_sodium_current_j_gate__j_inf;
	gates_tau[5][i] = var_fast_sodium_current_j_gate__tau_j;
	outarray[7][i] = var_L_type_Ca_current_d_gate__d_inf;
	gates_tau[6][i] = var_L_type_Ca_current_d_gate__tau_d;
	outarray[8][i] = var_L_type_Ca_current_f_gate__f_inf;
	gates_tau[7][i] = var_L_type_Ca_current_f_gate__tau_f;
	outarray[9][i] = var_L_type_Ca_current_f2_gate__f2_inf;
	gates_tau[8][i] = var_L_type_Ca_current_f2_gate__tau_f2;
	outarray[10][i] = var_L_type_Ca_current_fCass_gate__fCass_inf;
	gates_tau[9][i] = var_L_type_Ca_current_fCass_gate__tau_fCass;
	outarray[11][i] = var_transient_outward_current_s_gate__s_inf;
	gates_tau[10][i] = var_transient_outward_current_s_gate__tau_s;
	outarray[12][i] = var_transient_outward_current_r_gate__r_inf;
	gates_tau[11][i] = var_transient_outward_current_r_gate__tau_r;
