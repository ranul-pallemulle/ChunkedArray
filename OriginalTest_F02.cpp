...
void init_test(int n)
{
    ...
    gates.push_back(9);
    gates.push_back(10);
    concentrations.push_back(11);
    concentrations.push_back(12);
    n_var = 13;
    nq = n;
    ...
    Vmath::Fill(nq, -94.7,       cellSol[0],  1);
    Vmath::Fill(nq, 0.00024676,  cellSol[1],  1);
    Vmath::Fill(nq, 0.99869,     cellSol[2],  1);
    Vmath::Fill(nq, 0.99887,     cellSol[3],  1);
    Vmath::Fill(nq, 0.229,       cellSol[4],  1);
    Vmath::Fill(nq, 0.0001,      cellSol[5],  1);
    Vmath::Fill(nq, 0.00003742,  cellSol[6],  1);
    Vmath::Fill(nq, 1.0,         cellSol[7],  1);
    Vmath::Fill(nq, 0.0472,      cellSol[8],  1);
    Vmath::Fill(nq, 0.983,       cellSol[9],  1);
    Vmath::Fill(nq, 0.0001,      cellSol[10], 1);
    Vmath::Fill(nq, 0.942,       cellSol[11], 1);
    Vmath::Fill(nq, 320.0,       cellSol[12], 1);
}
