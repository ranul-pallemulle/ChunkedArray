...
COURTEMANCHE_BM=CRN98_chunked_interchanged_multithread_bm CRN98_chunked_interchanged_bm CRN98_original_withvecflags_bm CRN98_original_bm
COURTEMANCHE_AP=CRN98_chunked_interchanged_multithread_ap CRN98_chunked_interchanged_ap CRN98_original_withvecflags_ap CRN98_original_ap
...
FENTONKARMA_AP=FK_chunked_interchanged_multithreaded_ap FK_chunked_interchanged_ap FK_original_withvecflags_ap FK_original_ap
...
CRN98_chunked_interchanged_multithread_bm : Benchmark.o Globals_CRN98.o ChunkedArrayInterchangeTest_CRN98.cpp Vmath.o
	$(CC) -std=$(STD) $(OPT) $(EXTRA_FLAGS) -DMULTITHREAD $(CDEPS) $(VEC) $^ -o $@ $(LDEPS)

CRN98_chunked_interchanged_bm : Benchmark.o Globals_CRN98.o ChunkedArrayInterchangeTest_CRN98.cpp Vmath.o
...
CRN98_chunked_interchanged_multithread_ap : ActionPotentialTest.o Globals_CRN98.o ChunkedArrayInterchangeTest_CRN98.cpp Vmath.o
	$(CC) -std=$(STD) $(OPT) $(EXTRA_FLAGS) -DMULTITHREAD $(CDEPS) $(VEC) $^ -o $@ $(LDEPS)

CRN98_chunked_interchanged_ap : ActionPotentialTest.o Globals_CRN98.o ChunkedArrayInterchangeTest_CRN98.cpp Vmath.o
	$(CC) -std=$(STD) $(OPT) $(EXTRA_FLAGS) $(CDEPS) $(VEC) $^ -o $@ $(LDEPS)
...
FK_chunked_interchanged_multithreaded_bm : Benchmark.o Globals_FK.o ChunkedArrayInterchangeTest_FK.cpp Vmath.o
	$(CC) -std=$(STD) $(OPT) $(EXTRA_FLAGS) -DMULTITHREAD $(CDEPS) $(VEC) $^ -o $@ $(LDEPS)

FK_chunked_interchanged_bm : Benchmark.o Globals_FK.o ChunkedArrayInterchangeTest_FK.cpp Vmath.o
	$(CC) -std=$(STD) $(OPT) $(EXTRA_FLAGS) $(CDEPS) $(VEC) $^ -o $@ $(LDEPS)
...
FK_chunked_interchanged_multithreaded_ap : ActionPotentialTest.o Globals_FK.o ChunkedArrayInterchangeTest_FK.cpp Vmath.o
	$(CC) -std=$(STD) $(OPT) $(EXTRA_FLAGS) -DMULTITHREAD $(CDEPS) $(VEC) $^ -o $@ $(LDEPS)

FK_chunked_interchanged_ap : ActionPotentialTest.o Globals_FK.o ChunkedArrayInterchangeTest_FK.cpp Vmath.o
	$(CC) -std=$(STD) $(OPT) $(EXTRA_FLAGS) $(CDEPS) $(VEC) $^ -o $@ $(LDEPS)
